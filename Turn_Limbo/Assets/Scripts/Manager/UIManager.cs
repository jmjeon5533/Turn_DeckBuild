...
//     private void Update()
//     {
//         if (!controller.isGamePlayable) return;
...
//             bool isActiveBtn = controller.useAbleCoin >= skill.cost[dataManager.saveData.skillLv[skill.index]];
...
//     }
//     public void SetExplain(bool isActive, SkillInfo skill = null, Vector3 pos = default, int level = 0)
//     {
...
//             skill_Cost_Text.text = skill.act[level].ToString();
//         }
//     }
...
//         if (isWin) dataManager.saveData.money += Mathf.RoundToInt(moneyTarget);
//         EndMove = true;
//     }
